      ...
      <section className="relative bg-black text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 pt-32 pb-20">
          ...
          <p className="text-gray-300 text-lg leading-relaxed max-w-xl mb-8">
            Security policies, BGP configuration, and operational standards for the Extreme IX shared Layer 2 infrastructure.
          </p>
        </div>
      </section>
          ...
          <div className="lg:col-span-9 space-y-16">
            ...
            {/* IP Traffic Exchange */}
             <div id="ip-traffic" className="scroll-mt-32">
                ...
                <p className="text-gray-700 mb-6">IP traffic should be exchanged between Extreme IX members using BGP protocol by the following ways:</p>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white border border-gray-200 p-6 rounded-lg hover:shadow-lg transition-shadow">
                        ...
                        <p className="text-gray-600 text-sm">Between Extreme IX Members / Content providers with their mutual agreements.</p>
                    </div>
                </div>
            </div>
